...
Window::Window() {
    ...
    shapeComboBox->addItem(tr("Cykloida"), RenderArea::Cykloida);
    ...
    brushStyleComboBox->addItem(tr("Forward Gradient"), Qt::FDiagPattern);
   ...
   // mainLayout->setColumnStretch(3, 1);
    ...
    setWindowTitle(tr("Pracownia MMGK"));
...
void Window::penChanged()
{
    ...
    Qt::PenCapStyle cap = Qt::PenCapStyle(penCapComboBox->itemData(
            penCapComboBox->currentIndex()).toInt());
